...
//     * @return 脱敏后的日志信息
//     */
//    public String logHandle(String eventFormattedMessage) {
//        try {
//            // 原始信息 - 格式化后的
//            String originalMessage = eventFormattedMessage;
//            boolean flag = false;
//            // 获取Yml配置文件内容 - Map格式
//            Map<String, Object> patternMap = Yml.patternMap;
