...
import com.general.component.common.node.Node;
...
public class Tree<T> extends LinkedHashMap<String, Object> implements Node<T> {
    ...
    public Tree(TreeNodeConfig treeNodeConfig) {
        super();
        this.treeNodeConfig =
                (null != treeNodeConfig) ? treeNodeConfig : TreeNodeConfig.DEFAULT_CONFIG;
    }
    ...
    public Tree<T> getNode(T id) {
        return TreeSupport.getNode(this, id);
    }
    ...
    public List<CharSequence> getParentsName(T id, boolean includeCurrentNode) {
        return TreeSupport.getParentsName(getNode(id), includeCurrentNode);
    }
    ...
    public List<CharSequence> getParentsName(boolean includeCurrentNode) {
        return TreeSupport.getParentsName(this, includeCurrentNode);
    }
    ...
    public void putExtra(String key, Object value) {
        if (key == null || key.equals("")) {
            throw new NullPointerException("Key must be not empty !");
        }
        this.put(key, value);
    }
}
